...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_target_length', default=25, type=int, help="用于训练集划分的随机数")
    parser.add_argument('--per_device_eval_batch_size', default=128, type=int, help="用于训练集划分的随机数")
    ...
    for batch in process_bar:
        with torch.no_grad():
            ...
            generated_text = decode_text(generated_ids.cpu().numpy(), vocab, vocab_inp)
