...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Finetune a transformers trocr on a text classification task (NER) with accelerate library"
    )
    ...
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        help="Path to pretrained trocr or trocr identifier from huggingface.co/models.",
        required=False,
    )
    ...
    parser.add_argument("--show_steps", type=int, default=10, help="Total number of training epochs to perform.")
    ...
    parser.add_argument("--output_dir", type=str, default=None, help="Where to store the final trocr.")
    ...
    parser.add_argument("--push_to_hub", action="store_true", help="Whether or not to push the trocr to the Hub.")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Whether or not to enable to load a pretrained trocr whose head dimensions are different.",
    )
